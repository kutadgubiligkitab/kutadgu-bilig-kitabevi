...
test("pins use shop.js v=130 on homepage, book-shell, and static fixtures, and catalog-visibility.js v=3", () => {
  assert.match(indexHtml, /shop\.js\?v=130/);
  assert.match(indexHtml, /catalog-visibility\.js\?v=3/);
  assert.match(bookHtml, /shop\.js\?v=130/);
  assert.match(bookHtml, /catalog-visibility\.js\?v=3/);
  assert.match(romanlar2, /shop\.js\?v=130/);
