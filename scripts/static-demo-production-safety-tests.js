...
test("pins use shop.js v=113 on homepage, v=112 on book pages, and catalog-visibility.js v=3", () => {
  assert.match(indexHtml, /shop\.js\?v=113/);
  assert.match(indexHtml, /catalog-visibility\.js\?v=3/);
  assert.match(bookHtml, /shop\.js\?v=112/);
  assert.match(bookHtml, /catalog-visibility\.js\?v=3/);
  assert.match(romanlar2, /shop\.js\?v=112/);
