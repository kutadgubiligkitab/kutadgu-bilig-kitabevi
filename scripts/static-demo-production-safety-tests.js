...
test("pins use shop.js v=119 on homepage, v=117 on book-shell, v=115 on static fixtures, and catalog-visibility.js v=3", () => {
  assert.match(indexHtml, /shop\.js\?v=119/);
