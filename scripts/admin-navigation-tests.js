...
test("cache pins are admin.css v=37, admin.js v=64, admin-mfa.js v=3, and admin-idle.js v=3", () => {
  assert.match(adminHtml, /admin\.css\?v=37/);
  assert.match(adminHtml, /admin\.js\?v=64/);
