...
test("cache pins are admin.css v=30, admin.js v=49, admin-mfa.js v=2, and admin-idle.js v=2", () => {
  ...
  assert.doesNotMatch(adminHtml, /admin\.js\?v=48/);
  ...
  assert.match(adminHtml, /admin-original-price\.js\?v=4/);
