...
test("cache pins are admin.css v=32, admin.js v=51, admin-mfa.js v=2, and admin-idle.js v=2", () => {
  assert.match(adminHtml, /admin\.css\?v=32/);
  assert.match(adminHtml, /admin\.js\?v=51/);
  assert.match(adminHtml, /admin-mfa\.js\?v=2/);
  assert.doesNotMatch(adminHtml, /admin\.css\?v=31/);
  assert.doesNotMatch(adminHtml, /admin\.js\?v=50/);
  ...
  assert.match(adminHtml, /admin-price-history\.js\?v=1/);
