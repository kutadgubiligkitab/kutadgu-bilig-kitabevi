...
test("cache pins are admin.css v=38, admin.js v=65, admin-mfa.js v=3, and admin-idle.js v=3", () => {
  assert.match(adminHtml, /admin\.css\?v=38/);
  assert.match(adminHtml, /admin\.js\?v=65/);
