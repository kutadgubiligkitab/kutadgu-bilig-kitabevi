...
test("cache pins are admin.css v=23, admin.js v=41, admin-mfa.js v=2, and admin-idle.js v=2", () => {
  ...
  assert.doesNotMatch(adminHtml, /admin\.css\?v=22/);
  assert.doesNotMatch(adminHtml, /admin\.js\?v=40/);
});
