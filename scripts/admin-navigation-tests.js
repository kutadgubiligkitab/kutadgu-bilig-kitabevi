...
test("cache pins are admin.css v=29, admin.js v=46, admin-mfa.js v=2, and admin-idle.js v=2", () => {
  assert.match(adminHtml, /admin\.css\?v=29/);
  assert.match(adminHtml, /admin\.js\?v=46/);
  assert.match(adminHtml, /admin-mfa\.js\?v=2/);
  assert.doesNotMatch(adminHtml, /admin\.css\?v=28/);
  assert.doesNotMatch(adminHtml, /admin\.js\?v=45/);
  ...
  assert.match(adminHtml, /admin-original-price\.js\?v=1/);
