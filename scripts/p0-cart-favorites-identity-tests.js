...
test("storefront pages share shop.js v=85",()=>{
  ...
  assert.match(html,/shop\.js\?v=85/);
  assert.match(fav,/shop\.js\?v=85/);
  assert.match(home,/shop\.js\?v=85/);
  assert.doesNotMatch(html,/shop\.js\?v=84/);
