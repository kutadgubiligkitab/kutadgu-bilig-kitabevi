...
test("storefront pages share shop.js v=84",()=>{
  ...
  assert.match(html,/shop\.js\?v=84/);
  assert.match(fav,/shop\.js\?v=84/);
  assert.match(home,/shop\.js\?v=84/);
  assert.doesNotMatch(html,/shop\.js\?v=83/);
